  ...
  return (
    <section id="products" className="py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        <h2 className="text-3xl md:text-4xl font-display font-bold text-center mb-4">Our Products</h2>
        <p className="text-center text-muted-foreground font-body mb-12 max-w-xl mx-auto">
          Explore our premium range of grape-based products
        </p>
        {isLoading ? (
          ...
          <p className="text-center text-muted-foreground font-body">No products available yet.</p>
        )}
      </div>
    </section>
  );
